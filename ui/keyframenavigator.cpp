...
KeyframeNavigator::KeyframeNavigator(QWidget *parent, bool addLeftPad) : QWidget(parent) {
  ...
  left_key_nav->setIcon(hitvidio::icon::LeftArrow);
  ...
  key_addremove->setIcon(hitvidio::icon::Diamond);
  ...
  right_key_nav->setIcon(hitvidio::icon::RightArrow);
  ...
  keyframe_enable->setIcon(hitvidio::icon::Clock);
