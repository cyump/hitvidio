...
public:
  ...
  /**
     ...
     *
     * NOTE: It's recommended to use update_project_filename() from Hitvidio::Global to update the filename completely
  ...
  /**
     ...
     *
     * Loads a shortcut configuration from file and sets Hitvidio to use them.
     *
     * @param fn
     *
  ...
  /**
     * @brief Load a CSS/QSS style from file to customize Hitvidio's interface.
     *
     * @param fn
     *
