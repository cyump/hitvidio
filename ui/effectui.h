...
public:
   ...
   *
   * Hitvidio allows users to modify several effects (of the same type) with one UI representation. To do this, you can
   ...
   *
   * Hitvidio allows users to modify several effects (of the same type) with one UI representation. The behavior is if
