...
class HitvidioAction : public QUndoCommand {
public:
  HitvidioAction(bool iset_window_modified = true);
  virtual ~HitvidioAction() override;
...
class MoveClipAction : public HitvidioAction {
public:
...
class RippleAction : public HitvidioAction {
public:
...
class DeleteClipAction : public HitvidioAction {
public:
...
class ChangeSequenceAction : public HitvidioAction {
public:
...
class AddEffectCommand : public HitvidioAction {
public:
...
class AddTransitionCommand : public HitvidioAction {
public:
...
class ModifyTransitionCommand : public HitvidioAction {
public:
...
class DeleteTransitionCommand : public HitvidioAction {
public:
...
class SetTimelineInOutCommand : public HitvidioAction {
public:
...
class AddMediaCommand : public HitvidioAction {
public:
...
class DeleteMediaCommand : public HitvidioAction {
public:
...
class AddClipCommand : public HitvidioAction {
public:
...
class LinkCommand : public HitvidioAction {
public:
  LinkCommand();
  virtual void doUndo() override;
  virtual void doRedo() override;
...
class CheckboxCommand : public HitvidioAction {
public:
...
class ReplaceMediaCommand : public HitvidioAction {
public:
...
class ReplaceClipMediaCommand : public HitvidioAction {
public:
...
class EffectDeleteCommand : public HitvidioAction {
public:
...
class MediaMove : public HitvidioAction {
public:
  MediaMove();
...
class MediaRename : public HitvidioAction {
public:
...
class KeyframeDelete : public HitvidioAction {
public:
...
class KeyframeAdd : public HitvidioAction {
public:
...
class SetClipProperty : public HitvidioAction {
public:
...
class AddMarkerAction : public HitvidioAction {
public:
...
class MoveMarkerAction : public HitvidioAction {
public:
...
class DeleteMarkerAction : public HitvidioAction {
public:
...
class SetSpeedAction : public HitvidioAction {
public:
...
class SetBool : public HitvidioAction {
public:
...
class SetSelectionsCommand : public HitvidioAction {
public:
...
class EditSequenceCommand : public HitvidioAction {
public:
...
class SetInt : public HitvidioAction {
public:
...
class SetLong : public HitvidioAction {
public:
...
class SetDouble : public HitvidioAction {
public:
...
class SetString : public HitvidioAction {
public:
...
class CloseAllClipsCommand : public HitvidioAction {
public:
  virtual void doUndo() override;
  virtual void doRedo() override;
};

class UpdateFootageTooltip : public HitvidioAction {
public:
...
class MoveEffectCommand : public HitvidioAction {
public:
  MoveEffectCommand();
  virtual void doUndo() override;
  virtual void doRedo() override;
...
class RemoveClipsFromClipboard : public HitvidioAction {
public:
...
class RenameClipCommand : public HitvidioAction {
public:
...
class SetPointer : public HitvidioAction {
public:
...
class ReloadEffectsCommand : public HitvidioAction {
public:
  virtual void doUndo() override;
  virtual void doRedo() override;
};

class SetQVariant : public HitvidioAction {
public:
...
class SetIsKeyframing : public HitvidioAction {
public:
...
class RefreshClips : public HitvidioAction {
public:
...
class UpdateViewer : public HitvidioAction {
public:
  virtual void doUndo() override;
  virtual void doRedo() override;
};

class SetEffectData : public HitvidioAction {
public:
...
class KeyframeDataChange : public HitvidioAction {
public:
