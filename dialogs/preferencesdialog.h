...
private:
   ...
   *
   * Defaults to FALSE, set this to TRUE if changing this setting should prompt the user for a restart of Hitvidio before
...
public:
   ...
   *
   * Each of Hitvidio's menu actions has a unique string ID (that, unlike the text, is not translated) for matching with
