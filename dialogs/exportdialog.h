 ...
 *
 * The dialog to initiate an export. Requires a valid Sequence to be set in hitvidio::ActiveSequence or the result is
 * defined (most likely a crash), so you should always do a `nullptr` check on hitvidio::ActiveSequence before constructing
 * this dialog.
 */
