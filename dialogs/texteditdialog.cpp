  ...
  rich_text_(rich_text)
{
  ...
  if (rich_text) {
    ...
    italic_button->setIcon(hitvidio::icon::CreateIconFromSVG(":/icons/italic.svg", false));
    ...
    underline_button->setIcon(hitvidio::icon::CreateIconFromSVG(":/icons/underline.svg", false));
    ...
    left_align_button->setIcon(hitvidio::icon::CreateIconFromSVG(":/icons/align-left.svg", false));
    ...
    center_align_button->setIcon(hitvidio::icon::CreateIconFromSVG(":/icons/align-center.svg", false));
    ...
    right_align_button->setIcon(hitvidio::icon::CreateIconFromSVG(":/icons/align-right.svg", false));
    ...
    justify_align_button->setIcon(hitvidio::icon::CreateIconFromSVG(":/icons/justify-center.svg", false));
