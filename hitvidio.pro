...
win32 {
    ...
    contains(DEFINES, hitvidio_OCIO) {
        LIBS += -lOpenColorIO
    }
}
...
mac {
    ...
    ICON = packaging/macos/hitvidio.icns
...
unix:!mac:effects.path = $$PREFIX/share/hitvidio-editor/effects

translations.files = $$PWD/ts/*.qm
unix:!mac:translations.path = $$PREFIX/share/hitvidio-editor/ts

unix:!mac {
    metainfo.files = $$PWD/packaging/linux/org.hitvidiovideoeditor.hitvidio.appdata.xml
    metainfo.path = $$PREFIX/share/metainfo
    desktop.files = $$PWD/packaging/linux/org.hitvidiovideoeditor.hitvidio.desktop
    desktop.path = $$PREFIX/share/applications
    mime.files = $$PWD/packaging/linux/org.hitvidiovideoeditor.hitvidio.xml
    mime.path = $$PREFIX/share/mime/packages
    icon16.files = $$PWD/packaging/linux/icons/16x16/org.hitvidiovideoeditor.hitvidio.png
    icon16.path = $$PREFIX/share/icons/hicolor/16x16/apps
    icon32.files = $$PWD/packaging/linux/icons/32x32/org.hitvidiovideoeditor.hitvidio.png
    icon32.path = $$PREFIX/share/icons/hicolor/32x32/apps
    icon48.files = $$PWD/packaging/linux/icons/48x48/org.hitvidiovideoeditor.hitvidio.png
    icon48.path = $$PREFIX/share/icons/hicolor/48x48/apps
    icon64.files = $$PWD/packaging/linux/icons/64x64/org.hitvidiovideoeditor.hitvidio.png
    icon64.path = $$PREFIX/share/icons/hicolor/64x64/apps
    icon128.files = $$PWD/packaging/linux/icons/128x128/org.hitvidiovideoeditor.hitvidio.png
    icon128.path = $$PREFIX/share/icons/hicolor/128x128/apps
    icon256.files = $$PWD/packaging/linux/icons/256x256/org.hitvidiovideoeditor.hitvidio.png
    icon256.path = $$PREFIX/share/icons/hicolor/256x256/apps
    icon512.files = $$PWD/packaging/linux/icons/512x512/org.hitvidiovideoeditor.hitvidio.png
    icon512.path = $$PREFIX/share/icons/hicolor/512x512/apps
    mime16.files = $$PWD/packaging/linux/icons/16x16/application-vnd.hitvidio-project.png
    mime16.path = $$PREFIX/share/icons/hicolor/16x16/mimetypes
    mime32.files = $$PWD/packaging/linux/icons/32x32/application-vnd.hitvidio-project.png
    mime32.path = $$PREFIX/share/icons/hicolor/32x32/mimetypes
    mime48.files = $$PWD/packaging/linux/icons/48x48/application-vnd.hitvidio-project.png
    mime48.path = $$PREFIX/share/icons/hicolor/48x48/mimetypes
    mime64.files = $$PWD/packaging/linux/icons/64x64/application-vnd.hitvidio-project.png
    mime64.path = $$PREFIX/share/icons/hicolor/64x64/mimetypes
    mime128.files = $$PWD/packaging/linux/icons/128x128/application-vnd.hitvidio-project.png
    mime128.path = $$PREFIX/share/icons/hicolor/128x128/mimetypes
    mime256.files = $$PWD/packaging/linux/icons/256x256/application-vnd.hitvidio-project.png
    mime256.path = $$PREFIX/share/icons/hicolor/256x256/mimetypes
    mime512.files = $$PWD/packaging/linux/icons/512x512/application-vnd.hitvidio-project.png
