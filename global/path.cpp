...
QList<QString> get_effects_paths() {
  ...
  effects_paths.append(app_dir.filePath("../share/hitvidio-editor/effects"));
  ...
  // Hitvidio will also accept a manually provided folder with an environment variable
...
QList<QString> get_language_paths() {
  ...
  // folder in share folder - best for Linux
  language_paths.append(app_dir.filePath("../share/hitvidio-editor/ts"));
